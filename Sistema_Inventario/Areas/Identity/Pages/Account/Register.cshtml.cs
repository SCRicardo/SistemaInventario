...
namespace Sistema_Inventario.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        //Agregamos la variable para el rol de usuario
        ...
        public class InputModel
        {
            ...
            //Agregamos la lista de roles como una propiedad
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                ListaRol = _roleManager.Roles.Where(r => r.Name != DS.Role_Cliente).Select(n => n.Name)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Le asignamos un rol al usuario y después lo cambiamos 
                    if(user.Role == null) //Esto significa que daremos de alta a un cliente
                    {
                   ...
                   //var code = await _userManager.GenerateEmailConfirmationTokenAsync(user);
                    ...
                    {
                        //La configuracion temporal de la estancia del usuario
                        if (user.Role == null)
                        {
                ...
                //Se recarga la lista de errores
                Input = new InputModel()
                {
                    ListaRol = _roleManager.Roles.Where(r => r.Name != DS.Role_Cliente).Select(n => n.Name)
                    .Select(l => new SelectListItem
